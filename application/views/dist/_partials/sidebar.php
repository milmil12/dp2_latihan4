      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php echo $this->uri->segment(2) == 'mahasiswa' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>mahasiswa"><i class="far fa-square"></i> <span>Mahasiswa</span></a></li>
